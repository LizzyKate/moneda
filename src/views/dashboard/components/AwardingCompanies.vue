...
<template>
  <div>
    <h2 class="text-lg text-[#080808] poppins-medium text-left 2xl:text-center">
      Transaction by awarding companies
    </h2>
  </div>
  <el-card
    class="!border-[#efefef] h-[350px] 2xl:h-[650px] !rounded-lg 2xl:w-3/4 lg:w-full ml-auto mt-4 !bg-transparent !p-3 !shadow-none"
  >
